...
/*
    ...
    */
    ...
    for(size_t i = 0; i < 1000; ++i)
    {
        ...
        for(size_t j = 0; j < 1; ++j)
        {
            ...
            for(size_t k = 0; k < 28; ++k)
            {
                for(size_t l = 0; l < 28; ++l)
                {
                    ...
                    // if(flag_b) cout << (cnn_neurons_b[0][j][k][l]) << endl;
                }
            }
        }
        ...
        //         {
        //             cnn_neurons[0][j][k][l] = sc.bit_gen(test_images[i][j][k][l]);
        //             if(flag_b) cout << "allen " << cnn_neurons_b[0][j][k][l] << endl;
        //         }
        //     }
        // }
        ...
        // for(size_t j = 0; j < 7 * 7 * 32; ++j)
        // {
        //     cout << "b " << fc_neurons_b[0][j] << endl;
        //     cout << "sc " << sc.print(fc_neurons[0][j]) << endl;
        // }
        ...
        for(size_t j = 0; j < 10; ++j)
        {
            ...
            if(flag_b && fc_neurons_b[1][j] > max_b)
            {
                max_b = fc_neurons_b[1][j];
                max_cand_b = j;
            }
        }
